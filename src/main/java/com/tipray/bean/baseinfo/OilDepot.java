 ...
 */
public class OilDepot extends BaseBean {
	private static final long serialVersionUID = 1L;
	/** 油库编号 */
	@ExcelField(title = "库位", order = 2)
	private String officialId;
	/** 油库名称 */
	@ExcelField(title = "油库名", order = 3)
	private String name;
	/** 油库简称 */
	@ExcelField(title = "油库简称", order = 4)
	private String abbr;
	/** 负责人 */
