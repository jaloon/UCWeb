...
public class PermissionAspect {
    ...
    public Object authentication(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        String[] accessAuthorities = accessAuthority.split(anno.mode());
     ...
     * @return 无权访问提示
     * @throws PermissionException if returnType is not one of [String, Message, ResponseMsg]
     */
