...
public interface OilDepotService {
     ...
     *
     * @param oilDepot    油库
     * @param readersJson 油库出入库读卡器集合JSON字符串
     * @param cardIds     油库相关卡ID集合（类似：“1,2”，ID之间以英文逗号相连）
     * @return
     * @throws Exception
     */
     ...
     * @return
     */
    Map<String, Object> getIdAndNameOfAllOilDepotsAndGasStations();

    /**
     * 获取所有油库和加油站的ID和名称
     *
     * @param depotVer   油库版本
     * @param stationVer 加油站版本
     * @return
     */
