 ...
 * RC4工具类
 * 
 * @author chenlong 2017-12-22
 *
 */
public class RC4Util {
	private static final Rc4Dll RC4_DLL = Rc4Dll.INSTANCE_DLL;
	...
	public static byte[] getKeyByDeviceId(Integer deviceId) {
		...
		// 设备ID，4个字节
		keyBuf.put(BytesConverterByLittleEndian.getBytes(deviceId));
		// 前15个字节CRC校验码，1个字节
	...
	public static String rc4ToHexString(byte[] dataBytes, byte[] keyBytes) {
		...
		return BytesUtil.bytesToHex(dataBytes, true);
	}
