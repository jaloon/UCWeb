...
public class DateUtil {
	...
	/** 1秒时间差（1000毫秒） */
	public static final long SECOND_DIFF = 1000L;
	/** 1分钟时间差（60秒） */
	public static final long MINUTE_DIFF = SECOND_DIFF * 60;
	/** 1小时时间差（60分钟） */
	public static final long HOUR_DIFF = MINUTE_DIFF * 60;
	/** 1天时间差（24小时） */
	public static final long DAY_DIFF = HOUR_DIFF * 24;
	/** 1月时间差（按30天计算） */
	public static final long MONTH_DIFF = DAY_DIFF * 30;
	/** 1年时间差（按365天计算） */
	public static final long YEAR_DIFF = DAY_DIFF * 365;
	...
	/**
	 * 根据自 1970 年 1 月 1 日 00:00:00 GMT 以来的秒数获取Date对象。
	 * @param second
	 * @return
	 */
	public static Date getDateByIntTime(int second) {
		long millisecond = second * 1000L;// 注意：此处必须乘以1000L，否则second * 1000的结果若大于0x7fffffff，则转为负数.
