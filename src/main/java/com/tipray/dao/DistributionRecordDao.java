...
public interface DistributionRecordDao extends BaseDao<DistributionRecord> {
     ...
     * 更新配送状态为换站
     *
     * @param transportId {@link Long} 配送记录的ID
     */
     ...
     * 更新配送状态
     *
     * @param transportId {@link Long} 配送ID
     * @param status      {@link Integer} 配送状态：<br>
     *                    0 未知<br>
     *                    1 配送未完成<br>
     *                    2 配送完成<br>
     *                    3 换站<br>
     ...
     * 根据远程换站信息添加配送记录
     *
     * @param changeInfo {@link ChangeInfo} 远程换站信息
     */
     ...
     * 根据配送单号获取最近的配送记录的ID
     *
     * @param invoice {@link String} 配送单号
     ...
     * 根据物流配送接口信息添加配送记录
     *
     * @param distributionMap {@link Map} 物流配送接口信息：<br>
     ...
     * 更新换站前配送记录的触发信息
     *
     * @param transportId {@link Long} 换站前配送记录的ID
     * @param changeId    {@link Long} 换站ID
     */
     ...
     * @return 配送记录
     */
    List<Map<String, Object>> findDistRecords(@Param("carId") Long carId,
