...
public class SendPacketBuilder {
	...
	public static ByteBuffer buildProtocol0x1202(int terminalId) {
		// 无数据体
		return buildSendPacket(terminalId, UdpBizId.TERMINAL_TRACK_CONFIG_UPDATE_REQUEST, null);
	}
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1203(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1203(int terminalId, long transportCard) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1204(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1204(int terminalId, String carNumber, byte storeNum) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1205(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1205(int terminalId, byte listenState) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1209(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1209(int terminalId, byte triggerState) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1207(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1207(int terminalId, byte bindType, List<Lock> locks) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1208(String terminalIds, String ftpPath, List<TerminalUpgradeFile> files) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1301(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1301(int terminalId, long sessionId, short interval, short duration) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1302(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1302(int terminalId, long sessionId) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1303(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1303(int terminalId, long sessionId) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1304(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1304(int terminalId, long sessionId) {
		ByteBuffer dataBuffer = buildDataBufForMonitorCancel(sessionId);
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1401(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1402(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1402(int terminalId, int alarmEliId, byte deviceType, int deviceId,
			byte alarmType, String userName) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1403(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1403(int terminalId, int remoteControlId, byte controlType, int stationId,
			String userName) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1404(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1404(int terminalId, int remoteControlId, byte carStatus, int stationId,
			String userName) {
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1405(int terminalId, ByteBuffer dataBuffer) {
	 ...
	 *            {@link byte} 锁个数
	 * @param list
	 *            {@link Integer} 锁设备ID和远程操作ID列表
	 * @param userName
	 *            {@link String} 操作员姓名，UTF-8编码
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildProtocol0x1405(int terminalId, byte lockNum, List<Integer> list, String userName) {
	 ...
	 * @return {@link ByteBuffer} 数据体
	 */
	public static ByteBuffer buildDataBufForCarBind(String carNumber, byte storeNum) {
	 ...
	 * @return {@link ByteBuffer} 数据体
	 */
	public static ByteBuffer buildDataBufForLockBind(byte bindType, List<Lock> locks) {
		// 锁数量
	 ...
	 * @return {@link ByteBuffer} 数据体
	 */
	public static ByteBuffer buildDataBufForTerminalSoftwareUpgrade(String terminalIds, String ftpPath,
		...
		for (TerminalUpgradeFile updateFile : files) {
			...
			// 添加文件CRC32，4个字节
			dataBuffer.put(BytesUtil.hexStringToBytes(updateFile.getCrc()));
		}
		return dataBuffer;
	}
	 ...
	 * @return {@link ByteBuffer} 数据体
	 */
	public static ByteBuffer buildDataBufForRealtimeMonitor(long sessionId, short interval, short duration) {
		// 构建协议数据体
	 ...
	 * @return {@link ByteBuffer} 数据体
	 */
	public static ByteBuffer buildDataBufForAlarmEliminate(int alarmEliminateId, byte deviceType, int deviceId,
			byte alarmType, String userName) {
	 ...
	 * @return {@link ByteBuffer} 数据体
	 */
	public static ByteBuffer buildDataBufForCarInOut(int remoteControlId, byte controlType, int stationId,
			String userName) {
		byte[] userNameBuf = userName.getBytes(StandardCharsets.UTF_8);
		int userNameBufLen = userNameBuf.length;
		// 缓冲区容量
	 ...
	 * @return {@link ByteBuffer} 数据体
	 */
	public static ByteBuffer buildDataBufForCarStatusAlter(int remoteControlId, byte carStatus, int stationId,
			String userName) {
		byte[] userNameBuf = userName.getBytes(StandardCharsets.UTF_8);
		int userNameBufLen = userNameBuf.length;
		// 缓冲区容量
	 ...
	 * @return {@link ByteBuffer} 数据体
	 */
	public static ByteBuffer buildDataBufForLockReset(byte lockNum, List<Integer> list, String userName) {
		byte[] userNameBuf = userName.getBytes(StandardCharsets.UTF_8);
		int userNameBufLen = userNameBuf.length;
		// 缓冲区容量
	 ...
	 * @return {@link ByteBuffer} 待发送数据
	 */
	public static ByteBuffer buildSendPacket(int remoteAddress, short biz, ByteBuffer dataBuffer) {
		// 序列号2个字节
