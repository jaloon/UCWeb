...
public class UdpClient {
     ...
     * 向UDP服务器发送数据
     *
     * @param sendPacket {@link DatagramPacket} 发送数据报包
     * @throws UdpException
     */
     ...
     *
     * @param sendBuf            发送数据字节数组
     * @param destinationAddress 指定目标UDP服务器地址
     * @param destinationPort    指定目标UDP服务器端口
     * @throws UdpException
     */
     ...
     * 接收UDP服务器回复的数据
     *
     * @param receivePacket {@link DatagramPacket} 接收数据报包
     * @throws UdpException
     */
     ...
     * UDP通信(车辆公共参数更新业务)
     *
     * @param commonParamList {@link byte} 公共配置文件列表，用位标识下列更新文件：<br>
     ...
     * @throws UdpException
     */
    public static ResponseMsg udpForTerminalSoftwareUpdateToMsg(int ver, String terminalIds, byte upgradeType, String ftpPath,
                                                                List<TerminalUpgradeFile> files) throws UdpException {
        ByteBuffer dataBuffer = SendPacketBuilder.buildDataBufForTerminalSoftwareUpgrade(ver, terminalIds, upgradeType, ftpPath, files);
     ...
     *
     * @param terminalId {@link int} 车载终端设备ID
     * @param lockIds    {@link Integer} 锁设备ID列表
     * @param userId     {@link int} 操作员ID
     * @param userName   {@link String} 操作员姓名，UTF-8编码
     * @return 应答结果：<code>true</code>成功；<code>false</code>失败
     * @throws UdpException
     */
