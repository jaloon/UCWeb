...
public class UdpBizId {
	private static final Logger logger = LoggerFactory.getLogger(UdpBizId.class);
	...
	static {
		...
		try {
			...
			bizIds = new short[0];
			logger.error("构建UDP业务ID集合异常：{}", e.toString());
		} finally {
