...
<pop:Permission ename="viewGasstation">
    ...
    <script id="table-tpl" type="text/html">
        <table cellspacing="0" cellpadding="0" border="0" class="" role="c-table" data-height="200">
            ...
            <tr>
                <th class="">
                    <div class="cell">加油站ID</div>
                </th>
                <th class="">
                    <div class="cell">加油站编号</div>
                </th>
                <th class="">
                    <div class="cell">加油站名称</div>
                </th>
                <th class="">
                    <div class="cell">加油站简称</div>
                </th>
                <th class="">
                    <div class="cell">加油站经纬度</div>
                </th>
                <th class="">
                    ...
                    <div class="cell">
                        ...
                        <pop:Permission ename="editGasstation">
                            ...
                            <img class="edit-btn" src="../../resources/images/operate/delete.png" alt="删除" title="删除"
                                 onclick="deleteGasstation({{$value.id}}, '{{$value.carNumber}}')">
                        </pop:Permission>
                    </div>
                </td>
            </tr>
            ...
            $.post(
                ...
                function (gridPage) {
                    ...
                    for (var i = 0; i < dataCount; i++) {
                        ...
                        jsonData.push({
                            id: gasstation.id,
                            officialId: gasstation.officialId,
                            name: gasstation.name,
                            abbr: gasstation.abbr,
                            coordinate: gasstation.longitude + ", " + gasstation.latitude,
                            director: gasstation.director,
                            phone: gasstation.phone,
                            address: gasstation.address,
                            company: gasstation.company,
                            remark: gasstation.remark
                        });
                    }
                    // 更新表格数据
