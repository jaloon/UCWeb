            		...
            		<div class="tab-con-list">
	            		<table class="base-table">
	                        <tr>
	                            <td>油库编号:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="officialId" value="${oilDepot.officialId}" readonly>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>油库名称:</td>
	                        ...
	                        <tr>
	                            <td>负责人:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="director" value="${oilDepot.director}" readonly>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>联系电话:</td>
	                        ...
	                        <tr>
	                            <td>联系地址:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="address" value="${oilDepot.address}" readonly>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>所属公司:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="company" value="${oilDepot.company}" readonly>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>经度:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="longitude" value="${oilDepot.longitude}" readonly>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>纬度:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="latitude" value="${oilDepot.latitude}" readonly>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>施解封半径:</td>
	                        ...
	                        <tr>
	                            <td>占地范围:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="region" value="${oilDepot.coverRegion}" readonly>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>备注:</td>
            		...
            		<div class="tab-con-list">
	            		<table class="base-table">
	                        ...
	                        <tr>
	                            <td>经度:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="longitude" value="${oilDepot.longitude}" required>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>纬度:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="latitude" value="${oilDepot.latitude}" required>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>施解封半径:</td>
	                            <td>
	                                <input type="text" class="editInfo" id="radius" value="${oilDepot.radius}" required>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>占地范围:</td>
	            		...
	            		<table class="sub-table" id="card_info">
	                        ...
	                        <c:forEach var="card" items="${cards}" varStatus="status">
	                            <tr>
	                                ...
	                                <td><img alt="删除" title="删除" src="../../resources/images/operate/delete.png" onclick="deleteTr(this,1)"></td>
	                            </tr>
	                        </c:forEach>
	                        <tr>
