...
<body>
    <div class="container">
            ...
            <pop:Permission ename="systemOperate">
                ...
                <pop:Permission ename="carManage">
                    <dl class="carManage">
                        ...
                        <%-- <pop:Permission ename="paramModule">
                            <dd><a name="normal/car/carParam.html">车辆参数设置</a></dd>
                        </pop:Permission>
                        <pop:Permission ename="remoteModule">
                            <dd><a name="normal/car/carRemote.jsp">车辆远程控制</a></dd>
                        </pop:Permission>
                        <pop:Permission ename="changeModule">
                            <dd><a name="normal/car/stationChange.jsp">车辆远程换站</a></dd>
                        </pop:Permission> --%>
                        <pop:Permission ename="monitorModule">
                            <dd><a name="normal/car/carSupervise.html?ctx=${pageContext.request.contextPath}">车辆参数设置及远程控制</a></dd>
                            <dd><a name="normal/car/carMonitor.html?ctx=${pageContext.request.contextPath}">车辆实时监控</a></dd>
                        </pop:Permission>
                        <pop:Permission ename="retrackModule">
                            <dd><a name="normal/car/carRetrack.html">车辆轨迹回放</a></dd>
                        </pop:Permission>
                    </dl>
                </pop:Permission>
                ...
                <pop:Permission ename="logManage">
                    <dl class="logManage">
                        ...
                        <pop:Permission ename="infologModule">
                            <dd class="first_dd"><a name="normal/log/logList.jsp">信息管理日志</a></dd>
                        </pop:Permission>
                        <%-- <pop:Permission ename="carlogModule">
                            <dd><a name="normal/log/logList.jsp">车辆管理日志</a></dd>
                            <dd><a name="normal/role/zTreeDemo.html">角色管理</a></dd>
                        </pop:Permission> --%>
                    </dl>
                </pop:Permission>
            </pop:Permission>
        ...
        <div class="main">
            <iframe src="normal/device/deviceList.jsp" frameborder="0" name="showContent" width="100%" height="100%"></iframe>
        </div>
    </div>
	<div class="alarm-box">
        <table id="alarm_tips">
